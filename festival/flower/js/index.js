;(() => {
  ...
  function CreateMagicDust(x1, x2, y1, y2, sizeRatio, fallingTime, animationDelay, node = 'main') {
    ...
    setTimeout(function(){
            document.querySelector('#sub').classList.remove('animate__fadeInOpcity');
            document.querySelector('#sub').classList.add('animate__fadeOutUp');
        setTimeout(function(){
            document.querySelector('#table').classList.remove('animate__fadeInOpcity');
            document.querySelector('#table').classList.add('animate__fadeOutOpcity');
        },600)
        setTimeout(function(){
            document.querySelector('#main').classList.remove('hov');
            document.querySelector('#main').classList.add('animate__fadeOutScale');
            setTimeout(function(){
                document.querySelector('.desc').style.display='block';
                document.querySelector('.desc').classList.add('descShow');
                setTimeout(function(){
                document.querySelector('.desc').classList.remove('descShow');
                },2000)
            },1000)
        },1000)
    },1000)
